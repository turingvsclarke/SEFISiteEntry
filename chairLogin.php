<!--
FILE NAME:n342-final/adminLogin.php
PURPOSE: 
MODIFICATION HISTORY:
11/04/20 Made comments
-->
<?php
    session_start();
...
<div class="w3-main our-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div id="formSpace" class="w3-twothird w3-container">
      <h2 class="w3-text-teal" id="formLabel">Session Chair login</h2><br/>

      <form id="loginForm" method="POST" action="actions/adminLogin.php">
